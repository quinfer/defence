...
ggsave("plots/fig-rtn50.png",width = width,height = height)
...
ggsave("plots/fig-rtn95.png",width = width,height = height)
...
ggsave("plots/fig-rtn5.png",width = width,height = height)
...
ggsave("plots/fig-vol50.png",width = width,height = height)
...
ggsave("plots/fig-vol95.png",width = width,height = height)
...
ggsave("plots/fig-vol5.png",width = width,height = height)
...
ggsave("plots/fig-rtnnet50.png",width = width,height = height)
...
ggsave("plots/fig-rtnnet5.png",width = width,height = height)
...
ggsave("plots/fig-rtnnet95.png",width = width,height = height)
...
ggsave("plots/fig-volnet50.png",width = width,height = height)
...
ggsave("plots/fig-volnet5.png",width = width,height = height)
...
ggsave("plots/fig-volnet95.png",width = width,height = height)
...
ggsave("plots/fig-TCI50.png",width = width,height = height)
...
ggsave("plots/fig-TCI5.png",width = width,height = height)
...
ggsave("plots/fig-TCI95.png",width = width,height = height)
...
ggsave("plots/fig-TCIrtd.png",width = width,height = height)
